...
import { IconViewAddress } from '../Icons'
...
const StyledIconViewAccountAddress = styled(IconViewAddress)`
...
export const ViewAddress = forwardRef(({ address, ...props }, ref) => {
